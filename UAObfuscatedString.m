...
- (instancetype)voahiuabxi { [self appendString:@"x"]; return self; }
- (instancetype)zuibiybaci { [self appendString:@"y"]; return self; }
- (instancetype)tacakjcnak { [self appendString:@"z"]; return self; }
